...
var FullCalendar = function(e) {
    ...
    if (Hr.prototype.classes = {}, Hr.prototype.iconClasses = {}, Hr.prototype.baseIconClass = "", Hr.prototype.iconOverridePrefix = "", "undefined" == typeof FullCalendarVDom) throw new Error("Please import the top-level fullcalendar libraries before attempting to import a plugin.");
        ...
        Ea = function() {
            function e(e) {
                ...
                this.subjectEl = null, this.selector = "", this.handleSelector = "", this.shouldIgnoreMove = !1, this.shouldWatchScroll = !0, this.isDragging = !1, this.isTouchDragging = !1, this.wasTouchScroll = !1, this.handleMouseDown = function(e) {
                    ...
                    passive: !0
                }), 1 === (ma += 1) && window.addEventListener("touchmove", Sa, {
                    passive: !1
                })
            }
            return e.prototype.destroy = function() {
                this.containerEl.removeEventListener("mousedown", this.handleMouseDown), this.containerEl.removeEventListener("touchstart", this.handleTouchStart, {
                    passive: !0
                }), (ma -= 1) || window.removeEventListener("touchmove", Sa, {
                    passive: !1
                })
    ...
    var Oa = function(e) {
        function t(t) {
            ...
            n.draggingSegEl = null, n.draggingSeg = null, n.eventRange = null, n.relevantEvents = null, n.validMutation = null, n.mutatedRelevantEvents = null, n.handlePointerDown = function(e) {
                ...
                }), d ? te() : ne(), t || (u && _a(s, e) && (u = null), n.validMutation = u, n.mutatedRelevantEvents = c)
            }, n.handleDragEnd = function(e) {
                var t = n.component.context,
                    o = n.eventRange.def,
    ...
    var ls = function(e) {
        ...
        cs = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.splitBusinessHourSegs = st(Ga), t.splitBgEventSegs = st(Ga), t.splitFgEventSegs = st(Ga), t.splitDateSelectionSegs = st(Ga), t.splitEventDrag = st(Ya), t.splitEventResize = st(Ya), t.buildBuildMoreLinkText = st(ds), t.rowRefs = new zi, t.state = {
    ...
    var bs = function(e) {
        ...
        ws = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.allDaySplitter = new ys, t.headerElRef = Lr(), t.rootElRef = Lr(), t.scrollerElRef = Lr(), t.state = {
                    slatCoords: null
                ...
                return f.push({
                    ...
                    chunks: [{
                        ...
                        content: function(e) {
                            ...
                            }, e.tableColGroupNode, Ar("tbody", null, Ar(bs, {
                                slatMetas: i
                            }))), Ar("div", {
            ...
            return n(t, e), t.prototype.render = function() {
                ...
                return Ar(ua, {
                    ...
                    return Ar("td", r({
                        ...
                        className: "fc-timegrid-now-indicator-container"
                    }, e.renderNowIndicator(t.nowIndicatorSegs)), Ar(Ws, {
                        date: t.date,
                        dateProfile: t.dateProfile,
                        todayRange: t.todayRange,
                        extraHookProps: t.extraHookProps
                ...
                var a = e.map((function(e) {
                    return Ar("div", {
                        ...
                        seg: e
                    }, bn(e, i.todayRange, i.nowDate))) : ca(t))
                }));
                return Ar(Wr, null, a)
    ...
    var Fs = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.processSlotOptions = st(Bs), t.state = {
                slatCoords: null
    ...
    }, e.triggerDateSelect = In, e.unmountComponentAtNode = Fr, e.unpromisify = Mr, e.version = "5.3.2", e.whenTransitionDone = $, e.wholeDivideDurations = tt, Object.defineProperty(e, "__esModule", {
        value: !0
    }), e
}({});